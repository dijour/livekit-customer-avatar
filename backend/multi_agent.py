...
class IntroAgent(Agent):
    def __init__(self) -> None:
        super().__init__(
            ...
            "Once you have both their name and location, call the information_gathered function "
            "with those details to switch to the story agent. "
...
class StoryAgent(Agent):
    ...
    async def on_enter(self):
        ...
        # using the LLM to generate a reply with our voice
        self.session.generate_reply(instructions="Let's start the story!")
